...
const Signincover = ({ ThemeChanger }: any) => {
    ...
    try {
      ...
      login(formValues).then((response) => {
        ...
        if (response?.data?.login?.success) {
          ThemeChanger({
            ...theme,
            user: response?.data?.login?.success?.user,
          });
          ...
          ThemeChanger({
            ...
            modal: true,
            modalTitle: "Error",
            modalMessage: response?.data?.login?.error?.message,
            modalButtonText: "Ok",
          });
        }
      });
          ...
          <div className="grid grid-cols-12 items-center h-full ">
            ...
            <div className="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-8 col-span-12">
              <div className="p-[3rem]">
                ...
                <p className="mb-4 text-[#8c9097] dark:text-white/50 opacity-[0.7] font-normal"></p>
                    ...
                    <div className="xl:col-span-12 col-span-12">
                      ...
                      <div className="input-group">
                        <input
                          ...
                          className="form-control form-control-lg  !border-s !rounded-md"
                          id="signin-password"
                        ...
                        <button
                          aria-label="button"
                          type="button"
                          className="ti-btn ti-btn-light !rounded-md !mb-0"
...
export default connect(mapStateToProps, { ThemeChanger })(Signincover);
