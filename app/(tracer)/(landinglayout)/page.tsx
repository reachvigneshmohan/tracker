...
import { FlipWords } from "@/shared/layout-components/ui/flip-words";
import GlobeDemo from "@/shared/layout-components/landing-page/githubGlobe";
const Landing = () => {
  const breakpoints = {
  ...
  const words = ["smarter", "efficiently", "reliably", "innovatively"];
  return (
    <Fragment>
      <Seo title={"Landing"} />
              ...
              <div className="grid grid-cols-12 gap-6">
                <div className="xxl:col-span-7 xl:col-span-7 lg:col-span-6 col-span-12">
                  <div className="xl:py-[3rem]">
                    <div className="mb-4">
                      <h5 className="font-semibold text-white opacity-[0.9] text-[4.25rem]">
                        Manage your Assets
                      </h5>
                    </div>
                    ...
                    <div className="text-[2rem] mb-[3rem] text-white opacity-[0.9]">
                      with Tracer v2.0!
                    </div>
